...
// describe('Test Restful Frontend', () => {
...
//         user.get()
//             .then(res => {
//                 return user.save({ "email": "yaame.zhu_1@cyanide.io" }) })
//             .then((res) => {
...
//             .then((res) => {
//                 return new User({ "email": "yaame.zhu@cyanide.io" }).save() })
//             .then((res) => {
//                 return user.get() })
//             .then((res) => {
...
//         users.fetch()
//             .then(res => {
//                 return users.create({ "email": "yaame.zhu_1@cyanide.io" }, { wait: true }) })
//             .then(res => {
//                 return users.create({ "email": "yaame.zhu_2@cyanide.io" }, { wait: true }) })
//             .then(res => {
//                 return users.create({ "email": "yaame.zhu_3@cyanide.io" }, { wait: true }) })
//             .then((res) => {
//                 return users.findWhere({ email: "yaame.zhu_1@cyanide.io" }).delete() })
//             .then((res) => {
//                 return users.findWhere({ email: "yaame.zhu_2@cyanide.io" }).delete() })
//             .then((res) => {
//                 return users.findWhere({ email: "yaame.zhu_3@cyanide.io" }).delete() })
//             .then((res) => {
//                 users.length.should.equal(1)
//                 done()
//             })
